...
export const GridScan: React.FC<GridScanProps> = ({
    ...
    sensitivity = 0.55,
    lineThickness = 1,
    // MODIFIED: Changed from '#392e4e' to a darker blue
    linesColor = '#1a237e',
    // MODIFIED: Changed from '#FF9FFC' to a cyan/blue color
    scanColor = '#00ffff',
    // MODIFIED: Toned down opacity from 0.4
    scanOpacity = 0.2,
    gridScale = 0.1,
    lineStyle = 'solid',
    lineJitter = 0.1,
    ...
    enablePost = true,
    bloomIntensity = 0.5, // slightly boosted for potential effect, adjust if too bright
    bloomThreshold = 0,
    bloomSmoothing = 0,
